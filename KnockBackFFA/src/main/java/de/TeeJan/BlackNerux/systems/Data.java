...
public class Data {
    ...
    public static String prefix = "§8» §e§lKnockbackFFA §7▏ §7";
    public static String prefixSQL = "§8[§6KnockbackFFA SQL§8] §7";
    public static String noPerms = "§cYou do not have permission to execute this command!";
    public static String noPlayer = Data.prefix + "§cYou musst be a player!";
