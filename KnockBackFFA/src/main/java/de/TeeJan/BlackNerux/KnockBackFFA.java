...
public class KnockBackFFA extends JavaPlugin implements Listener {
    ...
    public void createFiles(){
        ...
        configuration.addDefault("MySQL.Database", "knockbackffa");
    ...
    public void createConnection(){
        ...
        (KnockBackFFA.mySQL = new MySQL(host,port,database,user,password))
                .update("CREATE TABLE IF NOT EXISTS KnockbackFFA(UUID varchar(120), Ranking varchar(64), Kills varchar(64), Deaths varchar(64), Coins varchar(64));");
    }
}